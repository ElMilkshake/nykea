    ...
    return (
        ...
        <body>
            <main>
                ...
                <div className="holder redes-sociales">
                    <h3 className="redes-h3">Nuestras redes sociales!</h3>
                    <div className="redes-link">
                        <a className="linkinstagram  " href="https://www.instagram.com/nykea_muebleria/">Instagram </a>
                        <a className="linkyoutube" href="https://www.youtube.com/channel/UChQB3KtRhB0MGQqUMxy0R0g">Youtube </a>
                        <a className="linkfacebook" href="https://www.facebook.com/profile.php?id=61564665790260">Facebook</a>
                    </div>
                </div>
            </main>
        </body>
